...
rich <- read_csv("data-derived/fish_structure_summary.csv") 
gradient <- read_csv(here("data-derived", "data_PCA_results.csv"))
fish_meta <- read_csv(here("data-raw", "metadata_fishes.csv")) 
